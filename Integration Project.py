...
total_of_plan = carrier_monthly_price * carrier_monthly_time * device_quantity2
...
totality_month1 = total_of_plan / carrier_monthly_time
...
total_of_plan2 = total_of_plan + totality_together
...
print("Your total cost of your cellular bill and monthly phone payments "
      ...
      format(total_of_plan2, "0.2f"), sep='')
...
totals_of_plan3 = total_of_plan2 + totality_together2
# * operation was used to multiply the total amount of money each device is,
